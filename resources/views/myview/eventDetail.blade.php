...
@section('link')
    ...
    <li class="breadcrumb-item"><a class="text-white" href="{{ route('event') }}">Events</a></li>
    <li class="breadcrumb-item active">{{ $read->judul_agenda }}</li>
@endsection
@include('myview.components.hero')
    <div class="container px-0 px-md-5 mb-5">
        <div class="row">
            <div class="col-12 col-md-9">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-12">
                            <div class="">
                                <img src="{{ asset('assets/upload/image/' . $read->gambar) }}" class="img-content rounded-top" style="height: 100%!important" alt="...">
                                <div class="border">
                        ...
                        <div class="col-12">
                            <form class="py-3" action="{{ route('cari-event') }}" method="get">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Cari Events" aria-label="Cari Events" name="keywords" aria-describedby="button-addon2">
                        ...
                        <div class="col-12">
                            <ul class="list-group pb-5">
                                ...
                                <li class="list-group-item">
                                    <a href="{{ asset('event/kategori/'.$read->nama_kategori_agenda) }}" style="color:green;">
                                        {{ $read->nama_kategori_agenda }}
                                    </a>
                                </li>
                            </ul>
