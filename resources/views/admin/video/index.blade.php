        ...
        <div class="table-responsive mailbox-messages">
            <table id="example1" class="display table table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <td>
                        <a href=""  onclick="window.open('{{ $video->path_link_video }}', '_blank')">{{ $video->path_link_video }}</a>
                    ...
                    <td><small><?php echo $video->deskripsi_video; ?></small></td>
