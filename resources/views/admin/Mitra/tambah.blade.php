...
<form action="{{ asset('admin/mitra/tambah_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
<div class="row form-group">
  <label class="col-md-3 text-right"> Nama Mitra </label>
  <div class="col-md-6">
    <input type="text" name="nama_mitra" class="form-control form-control-lg" placeholder="Nama Mitra" required="required" value="{{ old('nama_mitra') }}">
  </div>
</div>
