        ...
        <tbody>
          ...
          <?php $i=1; foreach($produk as $produk) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><img src="{{ asset('assets/upload/image/thumbs/'.$produk->gambar) }}" class="img img-thumbnail img-fluid"></td>
              <td><?php echo $produk->judul_galeri ?></td>
              <td><a href="{{ asset('admin/produk/kategori/'.$produk->id_kategori_produk) }}"><?php echo $produk->nama_kategori_produk ?></a></td>
              <td><a href="{{ asset('admin/produk/status_galeri/'.$produk->jenis_galeri) }}">
                  <?php echo $produk->jenis_galeri ?></a></td>
