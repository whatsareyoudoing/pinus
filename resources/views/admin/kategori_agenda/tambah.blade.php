...
<form action="{{ url('admin/kategori_agenda/tambah') }}" method="post" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		@if ($errors->has('nama_kategori_agenda'))
	      	<span class="text-danger">{{ $errors->first('nama_kategori_agenda') }}</span>
	    @endif  
	</div>
</div>
