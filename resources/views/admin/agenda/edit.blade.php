...
<form action="{{ asset('admin/agenda/edit_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            <input type="text" name="judul_agenda" class="form-control" placeholder="Judul atau Nama"
                required="required" value="<?php echo $agenda->judul_agenda; ?>">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="tempat" class="form-control" placeholder="Tempat pelaksanaan"
                required="required" value="<?php if (isset($_POST['tempat'])) {
                    echo old('tempat');
                } else {
                    echo $site->namaweb;
                } ?>">
    ...
    <div class="row form-group">
        ...
        <div class="col-md-2">
            <select name="status_agenda" class="form-control select2">
                ...
                <option value="Draft" <?php if ($agenda->status_agenda == 'Draft') {
                    echo 'selected';
